...
TESTS = [
    ...
    dict(name="t21_crash_precedence", mode="sym", rc=(-11, 139), verdict="crash",
         finding=None, reason="unhandled_target_signal"),
    ...
    dict(name="t27_timeout_crash", mode="fors", rc=(2,), fs_status=139,
         verdict="normal", finding=dict(reason="heap-use-after-free", is_uaf=1),
         note="deferred finding surfaced by child-timeout transport"),
]
