...
DEF_HELPER_FLAGS_4(bndldx32, TCG_CALL_NO_WG, i64, env, tl, tl, tl)
DEF_HELPER_FLAGS_4(bndldx64, TCG_CALL_NO_WG, i64, env, tl, tl, tl)
DEF_HELPER_FLAGS_6(bndstx32, TCG_CALL_NO_WG, void, env, tl, tl, i64, i64, tl)
DEF_HELPER_FLAGS_6(bndstx64, TCG_CALL_NO_WG, void, env, tl, tl, i64, i64, tl)
...
DEF_HELPER_4(boundw, void, env, tl, int, tl)
DEF_HELPER_4(boundl, void, env, tl, int, tl)
...
DEF_HELPER_FLAGS_3(fxsave, TCG_CALL_NO_WG, void, env, tl, tl)
DEF_HELPER_FLAGS_3(fxrstor, TCG_CALL_NO_WG, void, env, tl, tl)
DEF_HELPER_FLAGS_4(xsave, TCG_CALL_NO_WG, void, env, tl, i64, tl)
DEF_HELPER_FLAGS_4(xsaveopt, TCG_CALL_NO_WG, void, env, tl, i64, tl)
DEF_HELPER_FLAGS_4(xrstor, TCG_CALL_NO_WG, void, env, tl, i64, tl)
...
DEF_HELPER_FLAGS_4(sem_reg_materialize_address, TCG_CALL_NO_RWG, void, env, i32, tl, tl)
...
DEF_HELPER_FLAGS_6(sem_reg_xchg, TCG_CALL_NO_RWG, void, env, i32, i32, tl, tl, tl)
